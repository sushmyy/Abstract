...
public class hashMapExample {
	...
	public static void main(String[] args) {
		...
		Book b1=new Book("BookName1",111,"AuthorName1","Publisher1",6);
		Book b2=new Book("BookName2",112,"AuthorName2","Publisher2",7);
		Book b3=new Book("BookName3",113,"AuthorName3","Publisher3",8);
		Book b4=new Book("BookName4",114,"AuthorName4","Publisher4",9);
		obj1.put(1,b1);
        obj1.put(2,b2);
        obj1.put(3,b3);
        obj1.put(4,b4);
